...
sealed partial class App : Application
{
    ...
    void RegisterTypes(Container container)
    {
        ...
        container.Register<SyncStorageCacheService>(Reuse.Singleton);
        ...
        container.RegisterMapping<ILaunchTimeMaintenanceAsync, SyncStorageCacheService>(ifAlreadyRegistered: IfAlreadyRegistered.AppendNotKeyed);
    ...
    void InitializeLocalization()
    {
        ...
        try
        {
            I18NPortable.I18N.Current.Locale = ApplicationSettings.GetDefaultLocale() ?? I18NPortable.I18N.Current.Languages.FirstOrDefault(x => x.Locale.StartsWith(CultureInfo.CurrentCulture.Name))?.Locale;
        }
        catch
        {
