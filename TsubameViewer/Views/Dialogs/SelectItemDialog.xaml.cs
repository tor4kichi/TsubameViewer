...
public sealed partial class SelectItemDialog : ContentDialog
{
    ...
    async void SelectItemDialog_Opened(ContentDialog sender, ContentDialogOpenedEventArgs args)
    {
    ...
    void SelectItemDialog_PrimaryButtonClick(ContentDialog sender, ContentDialogButtonClickEventArgs args)
    {
        IsOptionRequested = false;
    }

    void SelectItemDialog_OptionButtonClick(object sender, RoutedEventArgs args)
    {
    ...
    void SelectItemDialog_CloseButtonClick(ContentDialog sender, ContentDialogButtonClickEventArgs args)
    {
        IsOptionRequested = false;
        MyListView.SelectedItems.Clear();
    }
