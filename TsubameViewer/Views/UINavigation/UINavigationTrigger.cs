...
public sealed class UINavigationTriggerBehavior : Behavior<FrameworkElement>
{
    ...
    bool _holding = false;
    void Instance_Holding(UINavigationManager sender, UINavigationButtons button)
    {
    ...
    void UINavigationManager_OnPressing(UINavigationManager sender, UINavigationButtons buttons)
    {
        _isFocusingWhenPressing = _nowFocusingElement;
    }

    void Instance_Pressed(UINavigationManager sender, UINavigationButtons button)
    {
