...
public static class TitleDigitCompletionTransform
{
    ...
    {
        var query = folder.CreateFileQueryWithOptions(FolderImageCollectionContext.CreateDefaultImageFileSearchQueryOptions(Models.FolderItemListing.FileSortType.TitleDecending));
